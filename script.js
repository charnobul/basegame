...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const upgradeIncomeCostDisplay = document.getElementById('upgrade-income-cost');
    ...
    if (username) {
        ...
        upgradeIncomeCostDisplay.textContent = upgradeIncomeCost;
        updatePlayerList();
    }
    ...
    transferBtn.addEventListener('click', () => {
        transferDiv.style.display = transferDiv.style.display === 'none' ? 'block' : 'none';
    });
